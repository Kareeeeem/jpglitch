...
if __name__ == "__main__":
	...
	parser.add_argument('-a', metavar="amount", type=int,
		help="a number used to replace data in the image file. must be between 0 and 99")
	parser.add_argument('-s', metavar="seed", type=int,
		help="a number used to determine which data gets replaced. Must be between 0 and 99")
